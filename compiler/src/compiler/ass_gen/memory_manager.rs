...
pub unsafe fn push_to_stack(register: i8) -> String {
...
pub unsafe fn pop_from_stack(register: i8) -> String {
...
pub fn heap_alloc(register: i8, addr: i16) -> String {
    format!("st, r{register}, {addr}")
}

/// Load data from addr in DM to register
pub fn read_from_dm(register: i8, addr: i16) -> String {
    format!("ld, r{register}, {addr}")
}

/// Generates ldi instruction
pub fn load_const(register: i8, const_val: i16) -> String {
